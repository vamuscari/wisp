...
const NVIM_JSON: &[u8] = include_bytes!("../../../nvim/lua/wisp/json.lua");
...
pub fn deploy(replace_incompatible: bool) -> Result<PathBuf, DeployError> {
    ...
    let assets = [
        ...
        ("nvim/lua/wisp/json.lua", NVIM_JSON),
...
return chunk(binary, "wisp-deployment-v{PROTOCOL_VERSION}", bundle .. "/nvim/lua/wisp/json.lua")
"#
    );
